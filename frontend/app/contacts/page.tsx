      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          ...
          <div className="flex justify-center space-x-6">
            <a href="https://wa.me/996555953466" target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white p-3 rounded-full hover:bg-green-600 transition-colors">
