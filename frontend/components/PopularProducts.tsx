...
export default function PopularProducts() {
  ...
  if (products.length === 0) {
    return (
      <div className="py-20 text-center">
        <p className="text-[#212121]" style={{ fontFamily: 'Open Sans, sans-serif, Helvetica, Arial' }}>Популярные товары не найдены</p>
      </div>
    );
  }
  ...
  return (
    <section className="w-full pt-4 md:pt-6 pb-16 md:pb-24">
